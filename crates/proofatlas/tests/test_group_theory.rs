...
fn run_group_problem(problem_file: &str, timeout_secs: u64) -> ProofResult {
    ...
    let prover = ProofAtlas::new(parsed.formula.clauses, config, create_selector(), parsed.interner);
