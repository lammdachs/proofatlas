...
from proofatlas.training.datasets.data import GraphDataset
from proofatlas.core.fol.logic import Problem
from proofatlas.parsers.vampire.parser import read_file as read_vampire
