#!/usr/bin/env python3
"""Configure libtorch discovery for building with PyTorch.
...
def main():
    ...
    config = f'''# Auto-generated by scripts/setup_libtorch.py
...
'''
    ...
    print()
    print("You can now build with: maturin develop")
