...
from proofatlas.core.fol.logic import _EQ, _TRUE, _FALSE, Function, Literal, Predicate, Variable, Clause, Problem
from proofatlas.parsers.vampire.lexer import vampire_lexer
